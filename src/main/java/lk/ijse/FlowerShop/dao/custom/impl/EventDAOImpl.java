...
import lk.ijse.FlowerShop.entity.Event;
/*
...
*/
    ...
    public static Event searchByName(String name) throws SQLException, ClassNotFoundException {
    ...
    public static boolean add(Event event1) throws SQLException, ClassNotFoundException {
    ...
    public static boolean delete(String eCode) throws SQLException, ClassNotFoundException {
