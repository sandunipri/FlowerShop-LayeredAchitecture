...
import lk.ijse.FlowerShop.entity.EventOrder;
...
public class EventOrderDAOImpl {
    ...
    public static boolean save(EventOrder eventOrder) throws SQLException, ClassNotFoundException {
    ...
    public static EventOrder searchByPOID(String id) throws SQLException, ClassNotFoundException {
